    ...
    <div class="container-fluid" oncontextmenu="return false;" onsubmit="showLoader()">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 login-form-container">
                <h3 class="login-heading font-weight-bold mb-4">Reset Your Password</h3>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control password " name="password_confirmation" id="confirm_password" placeholder="Confirm Password" autocomplete="off" />
                    </div>
             

                        <button type="submit" class="btn login-btn mt-4 mb-3 ">Confirm <span id="loader" style="display:none;">Loading...</span></button>
            </div>
        </form>
