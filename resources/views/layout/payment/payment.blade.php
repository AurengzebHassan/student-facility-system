    ...
    @include('layout.adminpanel.header')
        ...
        <div class="main" >
         ...
         <div class="items-detail">
            ...
            <a href="{{route ('newpayment.method')}}" style="margin-left: auto;" id="addItemBtn" class="btn btn-danger ">New Payment Method</a>
        </div>
        @if(session('warning'))
        ...
        <div class="details">
            <div class="recentOrders">
                <div class="cardHeader">
                    ...
                    <form action="{{ route ('showpayment.method')}}" method="GET" class="form-inline">
                ...
                <table>
                    <thead>
                        <tr>
                            <th  class="fw-bold">Method_Name</th>
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: {{ $loop->iteration % 2 == 0 ? '#f2f2f2' : 'transparent' }}">                                    
                                <td style="padding-right: 50px;"  class="fw-bold">{{  $paymentMethod->method_name }}</td>
                                <td style="padding-right: 50px;"  class="fw-bold">{{  $paymentMethod->account_name }}</td>
                                <td style="padding-right: 50px;"  class="fw-bold">{{  $paymentMethod->account_number }}</td>
                                <td style="padding-right: 50px;"  class="fw-bold">{{  $paymentMethod->branch }}</td>
                                
                                <td ><a href="{{ route('editpayment.method', ['id' => $paymentMethod->id]) }}" class="btn btn-primary btn-sm text-start">Edit</a>

 
                                    <a href="{{ route('deletepayment.method', ['id' => $paymentMethod->id]) }}" class="btn delete-button btn-danger btn-sm">Delete</a> </td></td>
...
// If there's a success flash message, display the toast
if (successMessage) {
Swal.fire({
    icon: 'success',
