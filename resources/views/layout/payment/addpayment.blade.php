  ...
  <div class="main">
    ...
    <div style="background-color: #FAFAFA;">
      ...
      <div class="items-detail">
        <span style="margin-right: auto;">New Payment Method</span>
            ...
            <div id="itemInputs" class="item-inputs">
              ...
              <div class="row">
                ...
                <div class="col-md-5 mt-3">
                  <form action="{{ route ('addpayment.method')}}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                      <label>Method Name <span style="color: rgb(219, 99, 62);">*</span></label>
                      <input type="text" id="itemName" name="method_name" class="form-control" value="{{ old('method_name') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="itemName" name="account_name" class="form-control" value="{{ old('account_name') }}"
                ...
                <div class="col-md-5 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="itemName" name="account_number" class="form-control" value="{{ old('account_number') }}"
...
@endif
                    ...
                    <div class="col-md-5 mt-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="itemName" name="branch" class="form-control" value="{{ old('branch') }}"
                              placeholder="Branch">
                            @if($errors->has('error'))
                            <div class="alert alert-danger">
                              {{ $errors->first('error') }}
