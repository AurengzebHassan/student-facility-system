  ...
  <div class="main">
    ...
    <div style="background-color: #FAFAFA;">
      ...
      <div class="items-detail">
        <span style="margin-right: auto;">Edit Sub Category</span>
            ...
            <div id="itemInputs" class="item-inputs">
              ...
              <div class="row">
                ...
                <div class="col-md-5 mt-3">
                    <form action="{{ route('editsubcategory.update', $subcategories->id) }}" method="post">
                    {{-- {{ route('editsubcategory', $subcategories->id) }} --}}
                    @csrf
                    <div class="form-group">
                      <label>Name <span style="color: rgb(219, 99, 62);">*</span></label>
                      <input type="text" id="itemName" name="name" class="form-control" value="{{ $subcategories->name }}"
                        placeholder="Name">
                ...
                <div class="col-md-5 mt-3">
                    ...
                    <div class="form-group">
                        <label for="category">Main Category <span style="color: rgb(219, 99, 62);">*</span></label>
