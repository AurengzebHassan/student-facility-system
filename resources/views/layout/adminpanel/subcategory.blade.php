    ...
    @include('layout.adminpanel.header')
        ...
        <div class="main" >
         ...
         <div class="items-detail">
          ...
          <a href="{{route ('addsubcategory')}}" style="margin-left: auto;" id="addItemBtn" class="btn btn-danger ">Add Sub-Category</a>
        </div>
        @if(session('warning'))
        ...
        <div class="details">
            <div class="recentOrders">
                <div class="cardHeader">
                    <h2>Sub Category</h2>
                    <form action="{{ route ('showsubcategory')}}" method="GET" class="form-inline">
                ...
                <table>
                    <thead>
                        ...
                        <tr>
                            <th  class="fw-bold">Main-Category</th>
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: {{ $loop->iteration % 2 == 0 ? '#f2f2f2' : 'transparent' }}">     
                            <td style="padding-right: 50px;" class="fw-bold">{{ $subcategory->category->name }}</td>
                                <td style="padding-right: 50px;">{{$subcategory->name}}</td>
                                <td>
                          <a href="{{ route('editsubcategory', ['id' => $subcategory->id]) }}" class="btn btn-primary btn-sm text-start" onclick="disableLink(event, this)">Edit</a> 
                                <a href="{{ route('deletesubcategory', ['id' => $subcategory->id]) }}" class="btn btn-danger delete-button btn-sm">Delete</a> </td>
                        </tr>  
                            @endforeach     
                    </tbody>
                </table>
