  ...
  <div class="main">
    ...
    <div style="background-color: #FAFAFA;">
      ...
      <div class="items-detail">
        <span style="margin-right: auto;">Edit Category</span>
            ...
            <div id="itemInputs" class="item-inputs">
              ...
              <div class="row">
                ...
                <div class="col-md-5 mt-3">
                  <form action="{{ route('editmaincategory', $category->id) }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                      <label>Name <span style="color: rgb(219, 99, 62);">*</span></label>
                      <input type="text" id="itemName" name="name" class="form-control" value="{{ $category->name }}"
                        placeholder="Name">
                ...
                <div class="col-md-5 mt-3">
                  <div class="form-group">
                    ...
                    <textarea id="itemDescription" name="description" value=""
                      class="form-control" placeholder="Item Description">{{$category->description }}</textarea>
