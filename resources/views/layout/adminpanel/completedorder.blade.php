            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th style="text-align: center">Order_quantity</th>
                  <th style="text-align: center">Total_Price</th>
                  <th style="text-align: center !important">Payment</th>
                  <th
                    style="padding-right: 50px; text-align: center !important"
                  >
                    Image
                  </th>
                  {{-- <th
                  ...
                  <th style="text-align: end !important">Status</th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                >
                  ...
                  <td style="padding-right: 50px">{{ $order->order_price }}</td>
                  <td style="padding-right: 50px">
                  ...
                  <td style="padding-right: 50px">
                    @if($order->image)
                    <img
                      src="{{ asset('payment/images/' . $order->image) }}"
                      class="order-image"
                      alt="Payment Image"
                  ...
                  {{-- <td>
                    {{
                    $order->created_at->setTimezone('Asia/Karachi')->format('M
                    d, Y h:i A') }}
                  </td> --}}
