  ...
  <div class="main">
    ...
    <div style="background-color: #FAFAFA;">
      ...
      <div class="items-detail">
        <span style="margin-right: auto;">Category</span>
              ...
              <div class="row">
                ...
                <div class="col-md-5 mt-3">
                  <form action="{{ route('addnewcategory') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="itemName" name="name" class="form-control" value="{{ old('name') }}"
                        placeholder="Name">
                      @if($errors->has('error'))
                      <div class="alert alert-danger">
                        {{ $errors->first('error') }}
                ...
                <div class="col-md-5 mt-3">
                  <div class="form-group">
                    ...
                    <textarea id="itemDescription" name="description" value="{{ old('description') }}"
                      class="form-control" placeholder="Item Description">{{ old('description') }}</textarea>
                  </div>
                </div>
