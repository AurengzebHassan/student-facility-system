   ...
   @include('layout.adminpanel.header')
        ...
        <div class="main" >
         ...
         <div class="items-detail">
            <span style="margin-right: auto;">In Stock</span>
         ...
         <div class="details">
            <div class="recentOrders">
                <div class="cardHeader">
                    ...
                    <form action="{{ route('instock') }}" method="GET" class="form-inline">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="padding-right: 50px;">Category</th>

                            <th style="padding-right: 50px;">Sub_Category</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="edit-product btn btn-primary btn-sm " href="{{ route('editproducts', ['uuid' => $product['uuid']]) }}" onclick="disableLink(event, this)">
                                    Edit
                                </a>
                            </td>
                            ...
                            <td>
                                <a href="{{ route('hide.delete', ['uuid' => $product['uuid']]) }}" class="btn btn-secondary btn-sm" onclick="disableLink(event, this)">Hide</a>
                            </td>

                            <td>
                                <a href="{{ route('productsoft.delete', ['uuid' => $product['uuid']]) }}" class="btn btn-danger btn-sm delete-button">Delete</a>
                            </td>
